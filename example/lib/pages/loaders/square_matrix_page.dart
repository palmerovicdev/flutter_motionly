...
class SquareMatrixPage extends StatefulWidget {
  const SquareMatrixPage({super.key});

  @override
  State<SquareMatrixPage> createState() => _SquareMatrixPageState();
}

class _SquareMatrixPageState extends State<SquareMatrixPage> {
  @override
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Loader animado con matriz de cuadrados que se expanden y contraen en diferentes direcciones. Perfecto para estados de carga modernos y dinámicos.',
                    style: TextStyle(
...
SquareMatrixLoader(
  ...
  direction: TraverseDirection.LEFT_UP_RIGHT_BOTTOM,
                  ...
                  buildExampleCard(
                    ...
                    'Animación que fluye desde la esquina inferior derecha',
                    isNarrow,
                    Center(
                      child: SquareMatrixLoader(
                        numberOfSquares: isNarrow ? 4 : 5,
...
SquareMatrixLoader(
  ...
  curve: Curves.easeInOut,
                  ...
                  buildExampleCard(
                    'Efecto Vertical',
                    'Animación que fluye de arriba hacia abajo',
                    isNarrow,
                    Center(
                      child: SquareMatrixLoader(
                        numberOfSquares: isNarrow ? 3 : 4,
...
SquareMatrixLoader(
  ...
  curve: Curves.easeInOut,
                  ...
                  buildExampleCard(
                    'Efecto Horizontal',
                    'Animación que fluye de izquierda a derecha',
                    isNarrow,
                    Center(
                      child: SquareMatrixLoader(
                        numberOfSquares: isNarrow ? 3 : 4,
...
SquareMatrixLoader(
  ...
  curve: Curves.easeInOut,
                  ...
                  buildExampleCard(
                    ...
                    'Loader compacto con animación rápida',
                    isNarrow,
                    Center(
                      child: SquareMatrixLoader(
                        numberOfSquares: 3,
...
SquareMatrixLoader(
  ...
  curve: Curves.bounceInOut,
                  ...
                  buildExampleCard(
                    'Matriz Grande',
                    'Loader con más cuadrados para un efecto más complejo',
                    isNarrow,
                    Center(
                      child: SquareMatrixLoader(
...
final _features = [
  {
    'icon': Icons.grid_on,
    'title': 'Matriz Configurable',
    'description': 'Ajusta el número de cuadrados y su tamaño según tus necesidades',
  },
  {
  ...
  },
  {
    ...
    'description': 'Colores, tamaños y velocidades completamente configurables',
  },
];
...
final _properties = [
  {
    ...
    'type': 'int',
    'default': '3',
    'description': 'Número de cuadrados en cada fila y columna de la matriz',
  },
  {
    'name': 'squareHeight',
    'type': 'double',
    'default': '40',
    'description': 'Altura y ancho de cada cuadrado en la matriz',
  },
  {
    'name': 'duration',
    'type': 'Duration',
  ...
  },
  {
    ...
    'type': 'Color',
    'default': 'Colors.blue',
    'description': 'Color de los cuadrados',
  },
  {
    'name': 'direction',
    'type': 'TraverseDirection',
    'default': 'LEFT_UP_RIGHT_BOTTOM',
    'description': 'Dirección en la que fluye la animación',
  },
  {
    'name': 'curve',
    'type': 'Curve',
